...
<main class="max-w-3xl mx-auto px-6 py-12 space-y-12">
  ...
  <p class="text-lg text-teal-800">
    ...
    and surrounding areas, RRC officially opened on January 1, 2026.
  </p>
  ...
  <section class="space-y-4">
    ...
    <p class="text-teal-700">
      ...
      mutual support, and the belief that long-term recovery is strengthened
      through connection, empowerment, and community.
    </p>
  </section>
